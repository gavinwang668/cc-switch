...
use cc_switch_core::services::webdav_sync as webdav_sync_service;
use cc_switch_core::settings::{self, WebDavSyncSettings};
...
mod tests {
    ...
    use cc_switch_core::error::AppError;
    use cc_switch_core::settings::{AppSettings, WebDavSyncSettings};
