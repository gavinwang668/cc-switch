...
pub async fn read_claude_plugin_config() -> Result<Option<String>, String> {
    cc_switch_core::claude_plugin::read_claude_config().map_err(|e| e.to_string())
}
...
pub async fn apply_claude_plugin_config(official: bool) -> Result<bool, String> {
    if official {
        cc_switch_core::claude_plugin::clear_claude_config().map_err(|e| e.to_string())
    } else {
        cc_switch_core::claude_plugin::write_claude_config().map_err(|e| e.to_string())
    }
}
...
pub async fn is_claude_plugin_applied() -> Result<bool, String> {
    cc_switch_core::claude_plugin::is_claude_config_applied().map_err(|e| e.to_string())
}
...
pub async fn apply_claude_onboarding_skip() -> Result<bool, String> {
    cc_switch_core::claude_mcp::set_has_completed_onboarding().map_err(|e| e.to_string())
}
...
pub async fn clear_claude_onboarding_skip() -> Result<bool, String> {
    cc_switch_core::claude_mcp::clear_has_completed_onboarding().map_err(|e| e.to_string())
}
