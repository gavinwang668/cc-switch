...
use cc_switch_core::services::s3_sync as s3_sync_service;
use cc_switch_core::settings::{self, S3SyncSettings};
...
mod tests {
    ...
    use cc_switch_core::error::AppError;
    use cc_switch_core::settings::{AppSettings, S3SyncSettings};
